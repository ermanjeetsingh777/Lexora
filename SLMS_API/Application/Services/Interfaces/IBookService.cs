...
public interface IBookService
{
    ...
    Task<IReadOnlyCollection<BookListItemResponse>> GetMemberDigitalBooksAsync(
        Guid memberId,
        string? search,
        string? category,
        CancellationToken cancellationToken = default);

    Task<(string FilePath, string ContentType, string FileName)?> GetMemberDigitalBookPdfAsync(
        Guid memberId,
        Guid bookId,
        CancellationToken cancellationToken = default);
}
