        ...
        children: [
            ...
            // --- Members ---
            {
                ...
                children: [
                    ...
                    { path: 'scan', loadComponent: () => import('./features/attendance/member-qr-scan/member-qr-scan-page.component').then((m) => m.MemberQrScanPageComponent) },
            ...
            // --- Attendance ---
            {
                ...
                children: [
                    ...
                    },
                    {
                        path: 'member-scan',
                        canActivate: [permissionGuard],
                        data: { permissions: [PermissionKey.AttendanceScannerUse, PermissionKey.AttendanceView], requireAll: false },
                        loadComponent: () => import('./features/attendance/member-qr-scan/member-qr-scan-page.component').then((m) => m.MemberQrScanPageComponent),
                    },
                ],
            },
