...
import { DashboardOccupancyComponent } from './dashboard-occupancy.component';
import {
...
describe('DashboardOccupancyComponent', () => {
  let fixture: ComponentFixture<DashboardOccupancyComponent>;
  let component: DashboardOccupancyComponent;
  ...
  beforeEach(async () => {
    ...
    fixture = TestBed.createComponent(DashboardOccupancyComponent);
