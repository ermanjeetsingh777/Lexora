...
@Component({
  ...
  standalone: true,
  imports: [RouterLink, ChartModule, PageHeaderComponent, SectionHeaderComponent, GlassCardComponent, KpiCardComponent, LucideArmchair, LucideTrendingUp, LucideClock, LucideBuilding2],
